...
export const memberRoleExcludedSearchTerms = [];
export const klownAutoAccessUserIds = ['1232248915756318755'];
export const kweenAutoAccessUserIds = ['402512615387037713'];
export const koolAutoAccessUserIds = ['293039760044195840'];
